...
import imgSpeaker from '../../../images2/speaker@2x.png';
export default function Speakers() {
  return (
    <div className="site_wrap--padding speaker">
      <h3 className="speaker__title">SPEAKERS</h3>
      <div className="speaker__item">
        <div className="thumbnail">
          <img src={imgSpeaker} alt="Speaker" />
          <p className="thumbnail__text thumbnail__text--above">
            ベンチャー事情に精通
          </p>
          <p className="thumbnail__text thumbnail__text--below">斎藤 祐馬</p>
        </div>
        <div className="speaker__item__text">
          2010年よりトーマツ ベンチャーサポート株式会社（現 デロイト トーマツ
          ベンチャーサポート株式会社）の事業立ち上げに参画。 2019年デロイト
          トーマツ ベンチャーサポート 代表取締役社長。公認会計士。
          世界中の大企業の新規事業創出支援、ベンチャー政策の立案まで手掛けている。起業家が大企業100人にプレゼンを行う早朝イベントMorning
          Pitch発起人。主な著書は『一生を賭ける仕事の見つけ方』（ダイヤモンド社）。新聞・雑誌・テレビ・オンラインメディア等、メディア掲載多数。「2017年
      ...
      <div className="speaker__item">
        ...
        <div className="speaker__item__text">
          株式会社ナビゲータープラットフォーム取締役/Longine編集長.
          株式会社OneMile Partners 代表取締役/Chief Contents Officer.
          GFリサーチ合同会社代表. 東京工業大学大学院非常勤講師. 以前はFidelity
          Internationalや日本生命でポートフォリオマネージャーや証券アナリスト.
          米国や欧州の小売やネット, メディア, 日本のエレクトロニクス, ゲーム,
          機械産業等テクノロジーセクターが専門.
          著書「銀行はこれからどうなるのか」（クロスメディア）「Google vs
          トヨタ」(KADOKAWA)「日本の電機産業」(日本経済新聞社出版)
          慶應義塾大学大学院修士課程修了
        </div>
      </div>
      <div className="speaker__item">
      ...
      <div className="speaker__item">
        <div className="thumbnail">
          <img src={imgSpeaker} alt="Speaker" />
          <p
            className="thumbnail__text thumbnail__text--above thumbnail__text--green"
          >
            学者　ベンチャーに詳しい
          </p>
          <p
            className="thumbnail__text thumbnail__text--below thumbnail__text--green thumbnail__text--bg"
          >
            木谷 哲夫
          </p>
          <p className="thumbnail__text thumbnail__text--center">DUMMY</p>
      ...
      <div className="speaker__item">
        <div className="thumbnail">
          <img src={imgSpeaker} alt="Speaker" />
          <p
            className="thumbnail__text thumbnail__text--above thumbnail__text--brown"
          >
            ファシリテーター
          </p>
          <p
            className="thumbnail__text thumbnail__text--brown thumbnail__text--below thumbnail__text--bg"
          >
        ...
        <div className="speaker__item__text">
          ...
          Designのクリエイティブディレクターを務める。現在はBrand
      ...
      <div className="speaker__item">
        ...
        <div className="speaker__item__text">
          ...
          NewsPicksに移籍。ブランド広告を専門に手掛ける、Brand
          Designチームの立ち上げからチーフプロデューサーを務める。
          （大企業色を出す場合に担当）
        </div>
      </div>
    </div>
