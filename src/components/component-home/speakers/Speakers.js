      ...
      <div className="bg__speaker--8">
        <div className="site_wrap--padding speaker">
          ...
          <div className="speaker__box">
            <div className="speaker__box__item" data-sal="slide-up" data-sal-duration="2s" data-sal-delay="100" ata-sal-easing="ease">
            ...
            <div className="speaker__box__item" data-sal="slide-up" data-sal-duration="2s" data-sal-delay="100" ata-sal-easing="ease">
              ...
              <div className="speaker__box__item--text">
                ...
                PRESS」、リクルート「R25」など多数の媒体に参加。同時にブックライターとして多数のビジネス書を制作。2015年よりNewsPicksに参画し、Brand Designのクリエイティブディレクターを務める。現在はBrand
